...
def augment_and_save(image, output_image_path, seq):
...
# image_folder = Path('C:\\Users\\USER\\Desktop\\data\\defect_detection\\aug\\csn_top_rot\\images')
# annotation_folder = Path('C:\\Users\\USER\\Desktop\\data\\defect_detection\\aug\\csn_top_rot\\labels')
# output_image_folder = Path('C:\\Users\\USER\\Desktop\\data\\defect_detection\\aug\\csn_top_rot\\output\\images')
# output_annotation_folder = Path('C:\\Users\\USER\\Desktop\\data\\defect_detection\\aug\\csn_top_rot\\output\\labels')

image_folder = Path('C:\\Users\\USER\\Desktop\\data\\detection\\dod_data\\jjb\\250219_viz_jjb_dod_v8s_25020309h20_add')
output_image_folder = Path('C:\\Users\\USER\\Desktop\\data\\detection\\dod_data\\jjb\\output')
...
seq = iaa.Sequential([
    ...
    # iaa.Affine(scale=(0.9, 1.0), rotate=(-5, 5), cval=255), # scale : 크기 조절, cval : 배경 흰색(255) 단일값으로 설정
...
for image_path in image_folder.glob('*.bmp'):  # 현재 원본 bmp만 있음. 다른 포맷도 추가 가능
    ...
    for i in range(1):  # 각 이미지에 대해 ()개의 증강된 이미지 생성
        ...
        augment_and_save(image, str(output_image_path), seq)
